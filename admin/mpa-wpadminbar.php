                ...
                <div class="mpa-notifications-container">
                    <button class="mpa-header-btn" id="mpa-notifications-btn">
                        ...
                        <?php if ($notifications['unread_count'] > 0): ?>
                            <span class="mpa-notification-dot"><?php echo $notifications['unread_count'] > 9 ? '9+' : $notifications['unread_count']; ?></span>
                        <?php endif; ?>
                    </button>
                            ...
                            <?php if (empty($notifications['items'])): ?>
                                <div class="mpa-notification-empty">
                                    <svg class="mpa-empty-icon" viewBox="0 0 24 24" stroke="currentColor" fill="none">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 17h5l-5 5v-5zM9 7h6a2 2 0 012 2v8a2 2 0 01-2 2H5a2 2 0 01-2-2V9a2 2 0 012-2h4z"/>
                                    </svg>
                                    <p>Nenhuma notificação</p>
                                </div>
                            <?php else: ?>
                                <?php foreach ($notifications['items'] as $notification): ?>
                                    <div class="mpa-notification-item <?php echo $notification['read'] ? 'read' : 'unread'; ?>" data-notification-id="<?php echo esc_attr($notification['id']); ?>">
                                        ...
                                        <?php if ($notification['action_url']): ?>
                                            <a href="<?php echo esc_url($notification['action_url']); ?>" class="mpa-notification-action">
                                                Ver
                                            </a>
                                        <?php endif; ?>
                                    </div>
